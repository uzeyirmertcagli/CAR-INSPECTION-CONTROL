...
public class Motorsiklet extends Tasitlar {

	public Motorsiklet(int km, LocalDate yil, Marka marka, LocalDate sonBakim, LocalDate sonMuayene,
	...
	public int muayeneyeKalanSure() {
		boolean kontrol = LocalDate.now().isAfter(sonMuayene.plusYears(2));
		if(kontrol==false) {
			int muayeneSure = (int) LocalDate.now().until(sonMuayene.plusYears(2), ChronoUnit.DAYS);
			return muayeneSure;
		}
		return 0;
	}
